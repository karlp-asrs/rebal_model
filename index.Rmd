...
df1=data.frame(Date=bbgdat$date,Mthly_rebal_costless=gdnocost,
               Mthly_rebal=gdmthly,Yrly_rebal=gdyrly,
               Buy_hold=bbgdat$gdbuyhold)
